...
if(isset($_SESSION['firstname'])){
  include 'dbh.php';
        ...
        $sql = "SELECT name, descrip, date, dept, contact FROM complaints WHERE complaints.concern='Director' ORDER BY date DESC";
...
<div class="container">
	<div class="row">
		...
		<section class="content">
			<h1>New Grievances Concerned to Director</h1><br>
